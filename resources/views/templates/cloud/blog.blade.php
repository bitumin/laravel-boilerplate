        ...
        <div class="row">
            <main class="col-md-9" style="display: block;">
                <article class="blog-item">
                    <img class="img-responsive center-block" src="{{ asset('img/cloud/blog_featured_img.jpg') }}">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="about-author">
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('img/cloud/author.jpg') }}" class="img-responsive center-block img-circle" alt="Author Thumbnail">
                                        </div>
                                        <div class="col-md-9">
                                            <p>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="well">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="{{ asset('img/cloud/commenter1.jpg') }}" class="img-responsive center-block" alt="First Comment">
                                        </div>
                                        <div class="col-md-10">
                                ...
                                <div class="well">
                                    <div class="row">
                                        <div class="col-md-2">
                                            <img src="{{ asset('img/cloud/commenter2.jpg') }}" class="img-responsive center-block" alt="Second Comment">
                                        </div>
                                        <div class="col-md-10">
                                            <p class="comment-info">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="popular">
                                <div class="popular-post">
                                    <img src="{{ asset('img/cloud/tab-widget2.jpg') }}" class="img-responsive center-block">
                                ...
                                <div class="popular-post">
                                    <img src="{{ asset('img/cloud/tab-widget1.jpg') }}" class="img-responsive center-block">
                                    <h5 class="post-widget-heading">Image Post Title here</h5>
                                    <span class="date">may 24,2015</span>
                                    <p>
                                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
