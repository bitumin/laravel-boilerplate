...
<div class="container">
    <div class="starting">
        <div class="row">
            <div class="col-md-6">
                <img src="{{ asset('img/lucy/LUCY2.png') }}" alt="LUCY" class="wow flipInY animated animated">
            </div>
            <div class="col-md-6">
...
<div id="video" class="wrapper">
    <div class="container">
        ...
        <img src="{{ asset('img/lucy/feature.png') }}" alt="feature" class="video img-responsive animation-box wow animated bounceInDown">
        <p>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 col-sm-pull-4 text-center">
                <div class="animation-box wow bounceIn animated">
                    <img class="highlight-left wow animated" src="{{ asset('img/lucy/spark.png') }}" height="192" width="48" alt="">
                    <img class="highlight-right wow animated" src="{{ asset('img/lucy/spark.png') }}" height="192" width="48" alt="">
                    <img class="screen" src="{{ asset('img/lucy/front.png') }}" alt="" height="581" width="300">
                </div>
            </div>
        </div>
    </div> <!-- /.container -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-sm-6 wow animated fadeInLeft">
                <img src="{{ asset('img/lucy/mb2.png') }}" alt="" class="pull-right left-img">
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 wow animated fadeInRight">
                <img src="{{ asset('img/lucy/mb2v.png') }}" alt="" class="pull-left right-img">
            </div>
        </div> <!-- /.row -->
    </div> <!-- /.container -->
</section> <!-- /#features -->
        ...
        <div class="row">
            <div class="col-xs-12">
                <div id="screenshots" class="owl-carousel owl-theme">
                    <a href="{{ asset('img/lucy/1.jpg') }}" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots">
                        <img src="{{ asset('img/lucy/1.jpg') }}" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="{{ asset('img/lucy/2.jpg') }}" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots">
                        <img src="{{ asset('img/lucy/2.jpg') }}" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="{{ asset('img/lucy/3.jpg') }}" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots">
                        <img src="{{ asset('img/lucy/3.jpg') }}" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="{{ asset('img/lucy/4.jpg') }}" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots">
                        <img src="{{ asset('img/lucy/4.jpg') }}" class="img_res wow animated zoomIn" alt="">
                    </a>
                    <a href="{{ asset('img/lucy/1.jpg') }}" class="item wow flipInY animated animated" data-lightbox-gallery="screenshots">
                        <img src="{{ asset('img/lucy/1.jpg') }}" class="img_res wow animated zoomIn" alt="">
                    </a>
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-2 col-sm-4 col-md-offset-3 wow animated fadeInLeft">
                <img src="{{ asset('img/lucy/team1.png') }}" alt="team">
                <img src="{{ asset('img/lucy/icon-p.png') }}" alt="icon-p" class="icon-p">
                <h3>Jhon Doe</h3>
                <p>DEVELOPER</p>
                <div class="img-hover">
                    ...
                    <img src="{{ asset('img/lucy/icon-m.png') }}" alt="icon-m" class="icon-m">
                </div>
            </div>
            <div class="col-md-2 col-sm-4 animation-box wow bounceIn animated">
                <img src="{{ asset('img/lucy/team2.png') }}" alt="team">
                <img src="{{ asset('img/lucy/icon-p.png') }}" alt="icon-p" class="icon-p">
                <h3>Riyana</h3>
                <p>DEVELOPER</p>
                <div class="img-hover">
            ...
            <div class="col-md-2 col-sm-4 wow animated fadeInRight">
                <img src="{{ asset('img/lucy/team3.png') }}" alt="team">
                <img src="{{ asset('img/lucy/icon-p.png') }}" alt="icon-p" class="icon-p">
                <h3>RobertSmith</h3>
                <p>DEVELOPER</p>
                <div class="img-hover">
