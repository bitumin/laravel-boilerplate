                    ...
                    <div class="panel-body">
                        <div class="panel-group" id="accordion">
                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <h4 class="panel-title">
                                        <a aria-expanded="true" class="" data-toggle="collapse" data-parent="#accordion" href="#collapseThree">Collapsible Group Item #3</a>
                                    </h4>
                                </div>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-tabs">
                            <li class=""><a aria-expanded="false" href="#home" data-toggle="tab">Home</a>
                            </li>
                            <li class=""><a aria-expanded="false" href="#profile" data-toggle="tab">Profile</a>
                            </li>
                            <li class=""><a aria-expanded="false" href="#messages" data-toggle="tab">Messages</a>
                            </li>
                            <li class="active"><a aria-expanded="true" href="#settings" data-toggle="tab">Settings</a>
                            </li>
                        </ul>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <ul class="nav nav-pills">
                            <li class=""><a aria-expanded="false" href="#home-pills" data-toggle="tab">Home</a>
                            </li>
                            <li class=""><a aria-expanded="false" href="#profile-pills" data-toggle="tab">Profile</a>
                            </li>
                            <li class=""><a aria-expanded="false" href="#messages-pills" data-toggle="tab">Messages</a>
                            </li>
                            <li class="active"><a aria-expanded="true" href="#settings-pills" data-toggle="tab">Settings</a>
                            </li>
                        </ul>
