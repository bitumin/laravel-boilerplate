...
@section('section')
    ...
    <p>
        <a href="{{ ($trashed) ? route('admin.tags.index') : route('admin.tags.overview', ['trashed']) }}" title=""> {{ ($trashed) ? trans('tags.overview.links.active') : trans('tags.overview.links.trashed') }} </a>
    </p>
...
@section ('cotable_panel_body')
    <table class="table table-bordered sortable">
        <thead>
        <tr>
            <th role="name"><a href="{!! route('admin.api.sort', ['tags', 'name', 'asc', $trashed]).'?page='.$currentPage !!}" title="Order by name" class="sort"> {{ trans("tags.overview.table_head.name") }} </a></th>
            <th role="created_at"><a href="{!! route('admin.api.sort', ['tags', 'created_at', 'asc', $trashed]).'?page='.$currentPage !!}" title="Order by created at" class="sort"> {{ trans("tags.overview.table_head.created_at") }} <span class="fa fa-sort-down fa-fw"></span> </a></th>
