        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                <div class="col-lg-12 col-md-12 form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                    {!! Form::text('title', isset($post) ? $post->title : '' , [ 'class' => 'form-control', 'id' => 'title', 'placeholder' => trans("posts.form.title.placeholder") ] ) !!}
                    @if ( $errors->has('title') )
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 form-group {{ $errors->has('slug') ? 'has-error' : '' }} has-feedback">
                    {!! Form::text('slug', isset($post) ? $post->slug : '', [ 'class' => 'form-control', 'id' => 'slug', 'placeholder' => trans("posts.form.slug.placeholder") ] ) !!}
                ...
                <div class="panel panel-{{{ isset($class) ? $class : 'default' }}}">
                    ...
                    <div id="collapsePublish" class="panel-collapse collapse in">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-4">
                                    {!! Form::label('status', trans("posts.form.publish.status.label") ) !!}
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    {!! Form::label('visibility', trans("posts.form.publish.visibility.label") ) !!}
                                </div>
                            ...
                            <div class="row" id="password-protected-post">
                                <div class="col-sm-4">
                                    {!! Form::label('password', trans("posts.form.publish.password.label") ) !!}
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    {!! Form::label('date', trans("posts.form.publish.publish_date.label") ) !!}
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    {!! Form::submit( trans("posts.form.publish.save_button.value"), [ 'class' => 'btn btn-success' ] ) !!}
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 form-group input-group" id="cat-form">
                                    {!! Form::text('newCategory','', [ 'class' => 'form-control', 'id' => 'newCategory', 'placeholder' => trans("posts.form.category.placeholder") ] ) !!}
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-sm-12 form-group input-group">
                                    {!! Form::text('newTags','', [ 'class' => 'form-control', 'id' => 'newTags', 'placeholder' => trans("posts.form.tags.placeholder") ] ) !!}
                                    <span class="input-group-btn">
