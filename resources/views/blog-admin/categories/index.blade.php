...
@section('section')
    ...
    <p>
        <a href="{{ ($trashed) ? route('admin.categories.index') : route('admin.categories.overview', ['trashed']) }}" title=""> {{ ($trashed) ? trans('categories.overview.links.active') : trans('categories.overview.links.trashed') }} </a>
    </p>
...
@section ('cotable_panel_body')
    <table class="table table-bordered sortable">
        <thead>
        <tr>
            <th role="name"><a href="{!! route('admin.api.sort', ['categories', 'name', 'asc', $trashed]).'?page='.$currentPage !!}" title="Order by name" class="sort"> {{ trans("categories.overview.table_head.name") }} </a></th>
            <th role="created_at"><a href="{!! route('admin.api.sort', ['categories', 'created_at', 'asc', $trashed]).'?page='.$currentPage !!}" title="Order by created at" class="sort"> {{ trans("categories.overview.table_head.created_at") }} <span class="fa fa-sort-down fa-fw"></span> </a></th>
