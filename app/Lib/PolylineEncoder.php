...
//
// The only required argument is points which is an array containing the coordinates for the polyline
//
// numLevels and zoomFactor are optional and indicate how many different levels of magnification the polyline has
...
//
// verySmall indicates the length of a barely visible object at the highest zoom level. The default value
// is 0.00001 By lowering this number you can decrease the number of coordinates used.
//
// forceEndpoints indicates whether or not the endpoints should be visible at all zoom levels.
// forceEndpoints is optional with a default value of true.  Probably should stay true regardless.
//
// Main methods:
//
